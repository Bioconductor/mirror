...
# Last Modified: 2015 Jun 19 02:09:45 PM
...
def add_description(package):
  ...
  description_text = u"""This is a read-only mirror of the Bioconductor SVN repository.{contributions} Bug\u00A0Reports:\u00A0https://support.bioconductor.org/p/new/post/?{encoded_package}{issues}. Package\u00A0Homepage:\u00A0http://bioconductor.org/packages/devel/bioc/html/{package}""".format(
